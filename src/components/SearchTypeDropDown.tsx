...
export default function SearchTypeDropDown({
  ...
  return (
    <Menu
      as="div"
      className="relative inline-block h-full rounded-md rounded-r-none border-[1px] border-gray-400 bg-skin-light-secondary 
          ...
          <div className="py-1">
            {SearchTypeOptions.map((option) => (
              <Menu.Item key={nanoid()}>
                <button
                  onClick={() =>
                    setSearchType(option.toLowerCase() as SearchTypeType)
                  }
