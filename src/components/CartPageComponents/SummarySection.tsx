		...
		<section className="flex flex-col justify-between px-4 py-6 md:px-7 md:py-10 lg:px-8 lg:py-20">
			<div>
				...
				<div className="flex items-center justify-between pt-5">
					<p className="flex-1 text-base leading-none text-gray-800 dark:text-white">
						Shipping
					</p>
					<p className="flex-1 text-end leading-none text-gray-800 dark:text-white">
						$
						{shippingLoading ? "loading..." : shippingCost
