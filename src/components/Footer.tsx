...
export function Footer() {
  return (
    <footer className="relative mt-[30vh] w-full bg-primary text-secondary-foreground">
      <div className="mt-32 mb-20 w-full px-8">
        <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-2">
          <h5 className="mb-6">Art It Up</h5>
          <div className="grid grid-cols-3 justify-between gap-4">
            {LINKS.map(({ title, items }) => (
              <ul key={title}>
                <h5 color="blue-gray" className="mb-3 font-medium opacity-40">
                  {title}
                </h5>
                {items.map((link) => (
                  <li key={link}>
        ...
        <div className="border-blue-gray-50 mt-12 flex w-full flex-col items-center justify-center border-t py-4 md:flex-row md:justify-between">
          <h5 className="text-blue-gray-900 mb-4 text-center font-normal md:mb-0">
            &copy; {currentYear}{" "}
