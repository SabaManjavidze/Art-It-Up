				...
				>
					<Tab.List className="flex w-full justify-center rounded-lg bg-skin-light-secondary p-2">
						{Tabs.map((tab, i) => (
							<Tab
								key={nanoid()}
								className={`mr-2 flex-1 rounded-md bg-skin-secondary px-3 py-4 text-sm font-medium hover:bg-skin-main focus:outline-none ${i == activeTab ? "ring-2 ring-indigo-400" : null
									} 
	    duration-150`}
							>
								{tab}
